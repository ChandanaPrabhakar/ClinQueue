  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="w-[40px]" /> {/* Empty div for spacing */}
      </div>
      ...
      <div className="space-y-4">
        {doctors.map((doctor) => (
          <motion.div
            ...
            className="cursor-pointer bg-secondary border border-bg-secondary rounded-3xl shadow-sm p-4 hover:shadow-md transition-shadow flex items-center"
          >
            {/* Avatar */}
            <div className="w-16 h-16 bg-bg-secondary text-primary rounded-full flex items-center justify-center text-xl font-bold mr-4">
